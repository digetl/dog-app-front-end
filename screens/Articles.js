...
const DATA = [
  ...
  },
  {
    ...
    text: "Don’t forget about your puppy’s toenails. If they’re left untrimmed, they can make things uncomfortable for you and your family. \r\rTrimming your puppy’s nails takes some care. Your veterinarian can give you a good idea of when and how to cut them. You may even just want to let your veterinarian or groomer do the job. \r\rBut, if you decide to do it yourself, here are some tips to get you started.",
  },
  {
    id: "003",
    title: "Canine Cognitive Dysfunction Syndrome - CDS in Dogs",
    text: "Canine cognitive disorder, also known as cognitive dysfunction, is a decline in the brain’s ability to function. Research suggest that signs of CDS occur in 23 percent of dogs 12 to 14 years old and in 41 percent of dogs older than 14 years. \r\rUnderstanding CDS \r\rAffected dogs develop amyloid plaques, a sticky buildup that accumulates on neurons in the front part of the brain, or frontal lobe. Among other things, the frontal lobe controls memory, learning, focus and sensory information. The plaques eventually spread to other areas of the brain, causing disorientation and lack of spatial awareness. Vision and hearing may also be affected.",
  },
  {
    id: "004",
    title: "Recognizing the Dangers of Overheating In Your Dog",
    text: "The potential for a dog to overheat can result in decreased performance as well as serious health conditions. A dog does not regulate his body temperature by sweating. Most adult dogs are good at controlling their body temperatures, except when they are put in stressful situations. \r\rIt is important to be aware of the signs of overheating, so you can take steps to avoid problems. “While a slight case of overheating will cause discomfort, the situation can advance to serious health problems if not attended to immediately,” says Purina Director of Sporting Dog Programs Bob West. “As a dog’s body temperature rises, the dog compensates by panting. Panting draws cooler air to the back of the throat and across the tongue, which cools the blood circulating to the core of the dog.” \r\rHigh humidity adds to the risk of overheating because it reduces the effect of panting since the saliva evaporates less quickly. While panting is an effective short-term solution, it is an inefficient method of lowering body temperature in the long run because the panting itself uses energy and that generates additional heat.",
  },
];
